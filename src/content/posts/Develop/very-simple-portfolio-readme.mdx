---
title: 오픈소스 포트폴리오 템플릿을 만들어 보았다
description: 누구나 편하게 깔끔한 포트폴리오를 가질 수 있다면
date: "2023-05-18"
keywords: [opensource, 오픈소스, portfolio, 포트폴리오, 이력서]
thumbnail: "/images/posts/Develop/very-simple-portfolio-readme/thumbnail.png"
---
...
<a href="https://github.com/sjoleee/very-simple-portfolio" target="_blank">깃허브 바로가기</a>


  <br />

어려울 것 같다구요? 댓츠노노.
<br />`markdown` 과 `json`만 작성할 줄 안다면, 손쉽게 만들 수 있어요!😇
...
> 🐢 문서 관리 앱을 이용해서 이력서 및 포트폴리오를 관리할 때, **조금 느리다고 생각하지 않았나요?**<br />
> ☹️ 문서 관리 앱이 제공하는 **디자인이 마음에 들지 않았나요?**<br />
> 📈 내 이력서가 얼마나 방문되었는지 **데이터를 알고싶지 않았나요?**<br />
...
제 포트폴리오도 `very simple portfolio` 를 사용해서 제작했어요. <a href="https://www.sjoleee.info/" target="_blank">👉👉 만든이 포트폴리오 보러가기 👉👉</a>
...
![](https://velog.velcdn.com/images/sjoleee_/post/f69b7e64-aed9-4fdc-80e2-2d6795a3fda7/image.gif)
...
나는 어떤 색 조합이 좋은지 모르겠다! 고민이신 분들은 마음에 드는 메인 컬러 하나만 정하신 후, <a href="https://color.adobe.com/ko/create/color-wheel" target="_blank">어도비 컬러</a>에서 `유사` `음영` 으로 어울리는 색을 찾아보셔도 좋을 것 같아요😉
혹은, <a href="https://color.adobe.com/ko/explore" target="_blank">어도비 컬러의 탐색 탭</a>에서 인사이트를 얻어보셔도 좋겠습니다.🌈
...
각 옵션에 대한 정보는 <a href="https://github.com/garmeeh/next-seo#nextseo-options" target="_blank">next-seo 문서</a>를 참고하세요!
...
원하는 이미지를 favicon으로 변환해주는 <a href="https://realfavicongenerator.net/" target="_blank">realfavicongenerator</a>를 사용해보셔도 좋을 것 같아요.
...
<a href="https://vercel.com/new" target="_blank">vercel</a>에서 github으로 로그인하신 후, 포트폴리오 레포지토리를 선택하여 배포해주시면 됩니다!
...
<a href="https://analytics.google.com/" target="_blank">google analytics</a> 에 방문하여 가입을 진행해주세요.<br />
...
<a href="https://analytics.google.com/" target="_blank">ga</a> 에서 페이지 방문과 실시간 방문자를 볼 수 있게 될거에요!


그리고, 구글에 포트폴리오가 검색될 수 있도록 <a href="https://support.google.com/webmasters/answer/9012289?hl=ko#request_indexing" target="_blank">구글 서치콘솔에 URL 색인 생성을 요청</a>하세요!
